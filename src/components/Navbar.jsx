    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <Link to={"/cart"} className="relative">
          <FaShoppingCart size={22} className="text-purple-700 cursor-pointer" />
          <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-purple-700 text-white aspect-square rounded-full text-[8px]">
            {getCartCount()}
          </p>
        </Link>

        <Bars3BottomRightIcon
          className="w-7 text-purple-700 font-bold sm:hidden"
